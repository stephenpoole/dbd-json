...
import Locale from "./locale.browser";
...
declare const Client: typeof Dbd;
export { Client, Item, Addon, Offering, Perk, PlayerType, Power, Amounts, Player, Rarity, Difficulty, ItemType, ModifierType, Language, LocaleData, Killer, Survivor, AddonModel, ItemModel, OfferingModel, PerkModel, PlayerModel, PowerModel, };
